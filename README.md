...
## 📁 Project Structure
=======
>>>>>>> 666bd6d511fdf8adeed777f211333a97efba55dd

```text
Project_GetAround/
├── api/
<<<<<<< HEAD
│   ├── main.py                       # FastAPI API (predict + docs)
...
│
├── notebooks/
│   ├── 01_delay_analysis_eda.ipynb   # Delay analysis
│   └── 02_pricing_modeling.ipynb     # Pricing ML modeling
│
├── data/
